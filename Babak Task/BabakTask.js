...
const cardIntegrationDiv = document.querySelectorAll(
...
// Ahmad Hashim's project: rmeove inputs if the user select the single and show the inputs if the user click on married //
const dataQ = [
  "spouse_first_name",
  "spouse_last_name",
...
// End Ahmad Hashim's project: rmeove inputs if the user select the single and show the inputs if the user click on married //
